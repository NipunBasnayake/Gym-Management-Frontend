...
export default function Members() {
    ...
    const filteredMembers = useMemo(() => {
        ...
        if (statusFilter !== 'all') {
            filtered = filtered.filter((member) =>
                statusFilter === 'active' ? member.activeStatus : !member.activeStatus
            );
        }
        ...
        return filtered;
    }, [members, searchTerm, statusFilter, dateFilter]);
    ...
    return (
        <div
            className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-900 dark:via-gray-900 dark:to-slate-800">
            <ToastContainer
                position="top-right"
                autoClose={3000}
