...
import { BarChart, Calendar, CreditCard, LogOut, MessageSquare, Users, Dumbbell } from 'lucide-react'
...
export default function Sidebar() {
    ...
    return (
        <>
            {/* Desktop Sidebar */}
            <div className="hidden md:flex md:w-72 md:flex-col md:h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 shadow-2xl relative overflow-hidden">
                        ...
                        {navItems.map((item) => (
                            ...
                            >
                                {({ isActive }) => (
                                    <>
                                        {isActive && (
                                            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-500 opacity-20 rounded-2xl"></div>
                                        )}
                ...
                <div className="p-6 relative z-10">
                    <div className="bg-slate-800/50 rounded-2xl p-1 backdrop-blur-sm border border-slate-700/50">
                        ...
                        >
                            <div className="p-2 bg-slate-700/50 rounded-xl mr-4 group-hover:bg-red-500/20 transition-all duration-300">
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg shadow-2xl border-t border-slate-200/50 dark:border-slate-700/50 z-50">
